...
$stmt = $conn->prepare("SELECT u.*, 
    (SELECT COUNT(*) FROM final_attendance a WHERE a.user_id = u.user_id) as total_attendance,
    (SELECT COUNT(*) FROM final_attendance a WHERE a.user_id = u.user_id AND a.status = 'Late') as total_late,
    (SELECT COUNT(*) FROM final_attendance a WHERE a.user_id = u.user_id AND a.status = 'On Time') as total_ontime
    ...
    <main class="main-content">
        <div class="profile-container">
            ...
            <div class="profile-header">
                <img src="<?php echo $user['profile_picture'] ?? '../images/avatar.png'; ?>"
                    alt="Profile Picture"
                    class="profile-picture">

                <div class="profile-info">
                    <h1><?php echo htmlspecialchars($user['name']); ?></h1>
                    <p><i class="fas fa-id-badge"></i> ID: <?php echo htmlspecialchars($user['user_id']); ?></p>
            ...
            <div class="profile-stats">
                <div class="stat-card">
                    <div class="stat-value"><?php echo $user['total_attendance']; ?></div>
                    <div class="stat-label">Total Attendance</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo $user['total_ontime']; ?></div>
                    <div class="stat-label">On Time</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo $user['total_late']; ?></div>
            ...
            <div class="profile-details">
                ...
                <p><strong>Role:</strong> <?php echo htmlspecialchars($user['role'] == 14 ? 'Admin' : 'User'); ?></p>
                ...
                <p><strong>Shift:</strong> <?php echo htmlspecialchars($user['shift_start']) . ' - ' . htmlspecialchars($user['shift_end']); ?></p>
            </div>
        </div>
    </main>
